...
1. **Вірність першоджерел:** Кожен документ отримано безпосередньо з офіційних джерел — гарантія фактичної точності.
...
4. **Багаті метадані:** Domain-специфічні теги (`machine_learning`, `agent-engineering`, `experimental-ml`, `model-architecture`, `ml-theory`, `industry-analysis`) для фільтрування.

5. **Семантичний пошук:** FAISS + MiniLM baseline дає стабільну релевантність для всіх 10 тестових запитів.
